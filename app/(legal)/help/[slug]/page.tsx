...
export async function generateMetadata({
  ...
  const url = `https://clipflow.to/help/${params.slug}`
  const title = `${article.title} — Clipflow help`
  const description =
    article.summary ??
    `${article.title} — answers, walk-throughs, and troubleshooting for Clipflow.`
  return {
    title,
    description,
