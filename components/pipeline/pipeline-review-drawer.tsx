...
function TransitionSubmit({
  ...
  return (
    <button
      ...
      className={
        variant === 'primary'
          ? 'inline-flex h-9 items-center gap-1.5 rounded-xl bg-[#0F0F0F] px-3.5 text-[12.5px] font-bold tracking-tight text-[#F4D93D] transition-all hover:bg-[#1A0F2A] disabled:cursor-not-allowed disabled:opacity-60'
