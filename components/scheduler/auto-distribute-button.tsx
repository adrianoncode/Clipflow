...
function SubmitButton({ count, disabled }: { count: number; disabled: boolean }) {
  ...
  return (
    <button
      ...
      className="group inline-flex w-full items-center justify-center gap-1.5 rounded-lg bg-[#2A1A3D] px-3 py-2 text-[11.5px] font-bold tracking-tight text-[#D6FF3E] transition-all hover:-translate-y-px hover:bg-[#1A0F2A] disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:translate-y-0"
      style={{
        fontFamily:
